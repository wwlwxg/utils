 ...
 */
package com.fatty.db2code.utils;
...
public class JdbcTypeResolver {
    ...
    static {
        ...
        nameToType.put(TYPE_INT, Types.INTEGER);
    ...
    private static final JdbcTypeResolver instance = new JdbcTypeResolver();
    
    private JdbcTypeResolver(){}
    
    public static JdbcTypeResolver getInstance() {
    	return instance;
    }
    
    /**
     * 通过字段的Types数字获取数据库字段类型
     * @param jdbcType
     * @return
     */
